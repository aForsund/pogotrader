 ...
 * 
 * @ManyToMany(mappedBy = "pokedex_moves") private Set<Move> moves = new
 * HashSet<>();
 * 
 * @ManyToMany(mappedBy = "legacy_moves") private Set<Move> legacyMoves = new
 * HashSet<>();
 * 
 * @ManyToMany(mappedBy = "elite_moves") private Set<Move> eliteMoves = new
 * HashSet<>();
 * 
 * public MoveSet() { }
 * 
